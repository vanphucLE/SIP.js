...
import processor from "../processVideo";
...
export class SessionDescriptionHandler {
  ...
  constructor(logger, mediaStreamFactory, sessionDescriptionHandlerConfiguration) {
    ...
    this._peerConnection = new RTCPeerConnection(
      sessionDescriptionHandlerConfiguration === null || sessionDescriptionHandlerConfiguration === void 0
        ? void 0
        : sessionDescriptionHandlerConfiguration.peerConnectionConfiguration
    );
    this.initPeerConnectionEventHandlers();
    console.log("Tri------Local media Stream is", this._localMediaStream);
  }
  /**
  ...
  getDescription(options, modifiers) {
    ...
    const iceRestart =
      (_a = options === null || options === void 0 ? void 0 : options.offerOptions) === null || _a === void 0
        ? void 0
        : _a.iceRestart;
    // ICE gathering timeout may be set on a per call basis, otherwise the configured default is used
    const iceTimeout =
      (options === null || options === void 0 ? void 0 : options.iceGatheringTimeout) === undefined
        ? (_b = this.sessionDescriptionHandlerConfiguration) === null || _b === void 0
          ? void 0
    ...
    return this.getLocalMediaStream(options)
      ...
      .then((sessionDescription) => {
        console.log("Tri------set local Session Description", sessionDescription.sdp);
      ...
      .then((sessionDescription) => {
        console.log("Tri----Pre SDP", sessionDescription);
        this.setLocalSessionDescription(this.stripTcpCandidates(sessionDescription));
      })
      .then(() => this.getLocalSessionDescription())
      .then((sessionDescription) => {
        console.log("Tri----After SDP", sessionDescription);
        return {
  ...
  stripTcpCandidates(description) {
    // description.sdp = (description.sdp || "").replace(/^c=IN.*?\r\n/img, "c=IN IP4 0.0.0.0\n");
    // description.sdp = (description.sdp || "").replace(/^m=video \d+/img, "m=video 9");
    // description.sdp = (description.sdp || "").replace(/^m=audio \d+/img, "m=audio 9");
    // description.sdp = (description.sdp || "").replace(/opus\/48000/img, "opus\/8000");
    console.log("Tri0-----Description is", description);
    let newDescription = { sdp: description.sdp, type: description.type };
    newDescription.sdp = (description.sdp || "").replace(/^a=candidate:\d+ \d+ tcp .*?\r\n/gim, "");
    return Promise.resolve(newDescription);
  }
  ...
  setDescription(sdp, options, modifiers) {
    ...
    // Callback on data channel creation
    console.log("Tri------SetDesciption sdp", sdp);
    this.onDataChannel = options === null || options === void 0 ? void 0 : options.onDataChannel;
    // SDP type
      ...
      case "stable":
        ...
        try {
          this._dataChannel = this._peerConnection.createDataChannel(
            (options === null || options === void 0 ? void 0 : options.dataChannelLabel) || "",
            options === null || options === void 0 ? void 0 : options.dataChannelOptions
          );
    ...
    switch (this._peerConnection.signalingState) {
      ...
      case "have-remote-offer":
        ...
        return this._peerConnection.createAnswer(
          options === null || options === void 0 ? void 0 : options.answerOptions
        );
      case "have-local-offer":
      case "have-local-pranswer":
      case "have-remote-pranswer":
  ...
  getLocalMediaStream(options) {
    ...
    console.log("Tri--------options is", options);
   ...
   */
  async setLocalMediaStream(rawstream, options) {
